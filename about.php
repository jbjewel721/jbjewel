...
?>
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
				<div class="col-lg-6">
                    <div class="banner-frame"> <img class="img-fluid" src="images/about_us.jpg" alt="" />
                    </div>
                </div>
                <div class="col-lg-6">
                    <h2 class="noo-sh-title-top"> <span>Designer Shop</span></h2>
                    <p>
 	This project will be basic for the development & implementation of the computerized system for better efficiently, effective utilization.
 	...
 	All these function are interlinked to each other, which depend on the flow of information amongst them.
            ...
            <div class="row my-4">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/img-2.jpg" alt="" />
                            <div class="team-content">
                                <h3 class="title">Shyam</h3> <span class="post">Web Developer</span> </div>
                            <ul class="social">
                                <li>
                                    <a href="#" class="fab fa-facebook"></a>
                                </li>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        ...
                        <video controls autoplay muted height="50%" width="100%">
