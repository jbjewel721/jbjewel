            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        ...
                        <form action="Contect.php" method="POST" id="contactForm">
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                     <select class="form-control" id="subject" name="name" placeholder="Select Item" required data-error="Please enter your Subject">> --> --> >
                                        
                                        <option>selcet Items</option>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" placeholder="Your Mobile_No" id="mobileno" class="form-control" name="name" required data-error="Please enter your Mobile No.">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
